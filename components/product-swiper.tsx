            ...
            <div className="relative flex-grow">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/50 to-transparent p-4">
                <div className="flex justify-between items-end">
                  <div>
                    <h2 className="text-xl font-bold text-white">{nextProduct.name}</h2>
                  ...
                  <div className="text-right">
                    <p className="text-lg font-bold text-white">${nextProduct.discountedPrice}</p>
                    <p className="text-sm text-gray-300 line-through">${nextProduct.price}</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="flex justify-between items-end">
                  <div>
                    ...
                    <div className="flex items-center mt-1 mb-2">
                      ...
                      <span className="text-xs text-white ml-1">{currentProduct.rating.toFixed(1)}</span>
                    </div>
                    <div className="flex space-x-2">
                  ...
                  <div className="text-right">
                    <p className="text-lg font-bold text-white">${currentProduct.discountedPrice}</p>
                    <p className="text-sm text-gray-300 line-through">${currentProduct.price}</p>
                  </div>
                </div>
              </div>
            </div>
